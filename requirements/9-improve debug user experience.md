Improve key binding and user experience:  
When the user presses D (instead of Shift + D), game physics stop and the screen is blurred.  
When the user selects an area of interest, it should be without the blurred filter.  
